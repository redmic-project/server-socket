...
public class IngestDataTrackingTest extends IngestBaseTest {
	...
	final String WEBSOCKET_SEND_RUN_TASK = "/socket/tasks/ingest/tracking/run",
			WEBSOCKET_SEND_MATCHING = "/socket/tasks/ingest/tracking/resume/";
	// @formatter:on
	...
	static class ContextConfiguration {
		...
		@Bean
		public IngestDataTrackingBrokerListenerTest ingestDataTrackingBrokerListenerTest() {
			return new IngestDataTrackingBrokerListenerTest();
		}
	}
